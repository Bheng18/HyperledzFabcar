...
newTransaction.push(invoiceNumber);
if (req.method == "POST")
{
  newTransaction.push(billedTo);
  newTransaction.push(date);
  newTransaction.push(amount);
  newTransaction.push(description);
  newTransaction.push(GR);
  newTransaction.push(isPaid);
  newTransaction.push(repaid);
  newTransaction.push(repayment);
  request.fcn='createTransaction';
...
else if(req.method == "PUT")
{
    ...
    else if(color)
    {
      ...
      newTransaction.push(color);
       
    }
}


request.args=newTransaction;
console.log(request);
